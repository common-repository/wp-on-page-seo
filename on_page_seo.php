...
// Static members
//------------------------------------------------------------------------------
    const PLUGIN_BASE_URL = 'http://www.designmayor.com/';
    const AUTHOR_BASE_URL = 'http://www.designmayor.com/';
        ...
        switch ($hook) {
            case 'toplevel_page_' . self::SLUG:
                ...
                wp_enqueue_script('jquery-ui-widget',
                    self::$_pluginBaseUrl . '/js/jquery/ui/jquery.ui.widget.min.js',
                    array('jquery-ui-core'), '1.8.16');
                wp_enqueue_script('jquery-ui-progressbar',
                    self::$_pluginBaseUrl . '/js/jquery/ui/jquery.ui.progressbar.min.js',
                    array('jquery-ui-core', 'jquery-ui-widget'), '1.8.16');
